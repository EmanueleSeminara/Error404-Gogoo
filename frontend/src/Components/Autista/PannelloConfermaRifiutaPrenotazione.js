...
import CardConfermaRifiutaPrenotazione from "./CardConfermaRifiutaPrenotazione";
                ...
                <div className="col-sm-12 col-md-8 col-lg-6 my-auto ">
                    ...
                    {<div>
                        {/* this.state.listvehicles */data.map(((item) => (
                            ...
                            <CardConfermaRifiutaPrenotazione type={item.type} category={item.category} id={item.id} ritiro={this.ritiro} consegna={this.consegna} />
