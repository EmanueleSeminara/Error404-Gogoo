                    ...
                    <center className="screen">
                        <div className="pannellAdmin " >
                            <div className="d-flex justify-content-center flex-wrap">
                                <div >
                                    <center>
                                        <Button className="p-3 buttonAdmin " href=""><img className="iconAdmin" src={AggiungiVeicolo} /></Button>
                                        <Button className="p-3 buttonAdmin " href=""><img className="iconAdmin" src={RimuoviVeicolo} /></Button>
                                    </center>
                                </div>
                                <div >
                                    <center>
                                        <Button className="p-3 buttonAdmin " href=""><img className="iconAdmin" src={ModificaStatoVeicolo} /></Button>

                                        <Button className="p-3 buttonAdmin " href=""><img className="iconAdmin" src={PrenotazioniEffettuate} /></Button>
                                    </center>
                                </div>
                            </div>
                            <div className="d-flex justify-content-center flex-wrap">
                                <div>
                                    <center>
                                        <Button className="p-3 buttonAdmin " href=""><img className="iconAdmin" src={AggiungiUtente} /></Button>

                                        <Button className="p-3 buttonAdmin " href=""><img className="iconAdmin" src={RimuoviUtente} /></Button>
                                    </center>
                                </div>
                                <div>
                                    <Button className="p-3 buttonAdmin " href=""><img className="iconAdmin" src={ModificaDatiUtente} /></Button>

                                    <Button className="p-3 buttonAdmin " href=""><img className="iconAdmin" src={Logout} /></Button>
                                </div>
                            </div>
