          ...
          <div className="col boxpannel">
            <div className="row pannelLogin">
              <div className="col-10">
                ...
                <p style={{ color: "grey" }}>Per favore accedi per continuare</p>
                ...
                <center style={{ marginTop: "30px" }}>
                  <a
                    href="/recuperoPassword"
                    style={{ color: "#43AAA6", textDecoration: "none" }}
                  >
                ...
                Non hai un account?{" "}
                  <a
                    href="/registrazione"
                    style={{ color: "#9dffe8", textDecoration: "none" }}
                  >
                    Iscriviti
                  </a>
                </center>
