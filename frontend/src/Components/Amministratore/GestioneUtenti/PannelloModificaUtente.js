    ...
    Axios.get(
      ...
      .then((res) => {
        ...
        if (res.data.length === 0) {
          this.setState({
            string: "Non ci sono utenti con queste credenziali",
          });
      ...
      .catch((err) => {
        if (err.response.status === 422) {
          ...
          this.setState({
            string:
              "Per il momento non è possibile cercare gli utenti, riprova più tardi",
          });
          this.setState({ error: true });
        } else {
              ...
              <center>
                <ButtonGroup style={{ margin: "10px", flexWrap: "wrap" }}>
                  <Button
                    ...
                    onClick={() => this.setRSelected("guest")}
                  ...
                  <Button
                    ...
                    onClick={() => this.setRSelected("driver")}
                  ...
                  <Button
                    ...
                    onClick={() => this.setRSelected("valet")}
                  ...
                  <Button
                    ...
                    onClick={() => this.setRSelected("admin")}
