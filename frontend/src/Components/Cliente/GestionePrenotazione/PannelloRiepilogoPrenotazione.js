...
export default class PannelloRiepilogoPrenotazione extends Component {
  ...
  confirmation = () => {
    if (this.state.reservation.driver === true) {
      Axios.post(
        "/api/reservation/addreservationwithdriver",
              ...
              <div className="col-md-12">
                <div className="card-body">
                  <div className="row no-gutters">
                    <div className="col-md-12">
                      <center>
                        <h5 style={{ marginBottom: "50px" }} className="title">
                          Riepilogo prenotazione
                        </h5>
                      </center>
                      <p className="infoCard">
                        <strong>
                          ID veicolo: {this.state.reservation.refVehicle}
                        </strong>
                      </p>
                  ...
                  <div className="row no-gutters">
                    <div className="col-md-6">
                      <p className="infoCard">
                        <strong>Tipo:</strong> {this.state.reservation.type}{" "}
                        {this.state.reservation.type === "car" ? (
                          <> {this.state.reservation.category}</>
                        ) : (
                          <></>
                        )}
                      </p>
                      ...
                      <p className="infoCard">
                        ...
                        {this.state.reservation.dateR}
                      </p>
                    </div>
                    <div className="col-md-6">
                      <p className="infoCard">
                        <strong>Autista:</strong>{" "}
                        {this.state.reservation.driver ? <>si</> : <>no</>}
                      </p>{" "}
                      {/* TODO ########### */}
                      ...
                      <p className="infoCard">
                        ...
                        {this.state.reservation.dateC}
                      </p>
                    </div>
                    <p className="infoCard">
                      <strong>price:</strong> {Math.floor(this.state.price)}€
                    </p>
                  </div>
