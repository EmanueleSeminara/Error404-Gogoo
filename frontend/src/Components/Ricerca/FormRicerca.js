      ...
      <div className="ez sfondo" style={{ height: "100%" }}>
        ...
        <div className="row h-100 justify-content-md-center boxpannel">
          <div className="d-flex flex-column pannell-User boxRicerca ">
                ...
                <Button
                  className={
                    this.state.rSelected === "1"
                      ? "buttonCyanoGruoupSelected b1"
                      : "buttonCyanoGruoup b1"
                  }
                  onClick={() => {
                    this.setRSelected("1");
                ...
                <Button
                  className={
                    this.state.rSelected === "2"
                      ? "buttonCyanoGruoupSelected b2"
                      : "buttonCyanoGruoup b2"
                  }
                  onClick={() => {
                    this.setRSelected("2");
                    this.setState({ type: "car" });
                ...
                <Button
                  className={
                    this.state.rSelected === "3"
                      ? "buttonCyanoGruoupSelected b3"
                      : "buttonCyanoGruoup b3"
                  }
                  onClick={() => {
                    this.setRSelected("3");
                    this.setState({ type: "car" });
            ...
            {this.state.rSelected === "1" && <RicercaVeicoli />}
            {this.state.rSelected === "2" && <RicercaFuoriStallo />}
            {this.state.rSelected === "3" && <RicercaConAutista />}
          </div>
        </div>
      </div>
    );
