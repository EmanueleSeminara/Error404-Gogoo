          ...
          <div className="d-flex flex-column pannell-User ">
            <AvForm onValidSubmit={this.onValidSubmit}>
              {!this.state.selezionePagamento && (
                ...
                >
                  Scegliere almeno un metodo di pagamento
                </Alert>
              )}
              <center>
                <div
                ...
                >
                  {this.state.listpayments.map((item) => (
                    <CardPagamento
                      ...
                      number={item.number}
                      id={item.id}
                      seleziona={this.seleziona}
                      classes={
                        this.state.cardID === item.id
                ...
                <h6 className="infoCard" style={{ marginTop: "30px" }}>
                  Prezzo da pagare: {this.state.price}€
                </h6>
                <Button
              ...
              {this.state.success && (
                ...
                >
                  Pagamento confermato, tra 5 secondi verrai reindirizzato alla
                  ricerca
                </Alert>
              )}
            </AvForm>
